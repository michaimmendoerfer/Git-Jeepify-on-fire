...
void  PeerClass::SetPeriphValue(int P, float Value) { Periph[P].SetValue(Value); }
...
bool  PeerClass::GetPeriphChanged(int P) { return Periph[P].GetChanged(); }
void  PeerClass::SetPeriphChanged(int P, bool Changed) { Periph[P].SetChanged(Changed); }
...
bool  PeerClass::PeriphHasADS(int P) { return Periph[P].GetADS(); }
bool  PeerClass::GetPeriphADS(int P) { return Periph[P].GetADS(); }

int   PeerClass::GetPeriphType(int P) { return Periph[P].GetType(); }

int   PeerClass::GetPeriphVin(int P) { return Periph[P].GetVin(); }
void  PeerClass::SetPeriphVin(int P, float Vin) { Periph[P].SetVin(Vin); }

float PeerClass::GetPeriphVperAmp(int P) { return Periph[P].GetVperAmp(); }
void  PeerClass::SetPeriphVperAmp(int P, float VperAmp) { return Periph[P].SetVperAmp(VperAmp); }

int   PeerClass::GetPeriphIOPort(int P) { return Periph[P].GetIOPort(); }

PeriphClass *PeerClass::GetPeriphPtr(int P) { return &Periph[P]; }
