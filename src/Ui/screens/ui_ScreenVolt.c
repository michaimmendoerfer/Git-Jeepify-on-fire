...
void ui_ScreenVolt_screen_init(void)
{
    ...
    ui_LblPeerName2 = lv_label_create(ui_ScreenVolt);
    lv_obj_set_width(ui_LblPeerName2, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_LblPeerName2, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_LblPeerName2, 0);
    lv_obj_set_y(ui_LblPeerName2, 80);
    lv_obj_set_align(ui_LblPeerName2, LV_ALIGN_CENTER);
    lv_label_set_text(ui_LblPeerName2, "Peer");
    lv_obj_set_style_text_color(ui_LblPeerName2, lv_color_hex(0xAD0808), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_LblPeerName2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_LblPeerName2, &lv_font_montserrat_18, LV_PART_MAIN | LV_STATE_DEFAULT);
